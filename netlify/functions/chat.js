    ...
    try {
        ...
        const response = await fetch('https://api.anthropic.com/v1/messages', {
            ...
            body: JSON.stringify({
                ...
                max_tokens: 400,
                system: 'Du bist RalphiApp, die persoenliche Helfer-App von Raphy fuer ihn und seine Freundin Kathi. Antworte kurz, herzlich und im lockeren oberoesterreichischen Dialekt. Max 2-3 Saetze, gelegentlich Emojis.',
